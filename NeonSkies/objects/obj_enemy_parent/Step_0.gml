...
// Check if the enemy has reached the left side of the grid (x > 127)
if (x > 127 && !place_meeting(x - 1, y, obj_tower1) && !place_meeting(x - 1, y, obj_tower2) && !place_meeting(x - 1, y, obj_tower3) && !place_meeting(x - 1, y, obj_tower4)) {
    x -= speed; // Move left, speed can be customized for child objects
} else {
